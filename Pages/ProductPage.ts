...
export class ProductPage {
    ...
    // The View Cart link is usually an <a> inside the cart dropdown; target that
    this.lnkViewCart = page.locator('#cart .dropdown-menu a:has-text("View Cart")').first();
    }
    ...
    async clickViewCart(): Promise<ShoppingCartPage> {
        await this.lnkViewCart.waitFor({ state: 'visible', timeout: 5000 });
