...
export class HomePage {
    ...
    // target the top-links Login to avoid matching the sidebar login link
    this.linkLogin = page.locator('#top-links a:has-text("Login")').first();
    ...
    async clickLogin(){
        try {
            ...
            // fallback: click login link in right column
            const fallback = this.page.locator('#column-right a:has-text("Login")').first();
